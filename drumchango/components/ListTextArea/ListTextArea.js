(async () => {
  const res = await fetch('components/ListTextArea/ListTextArea.html');
  ...
  class ListTextArea extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-text-area', ListTextArea);
