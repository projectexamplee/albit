(async () => {
  const res = await fetch('components/ListValueStrong/ListValueStrong.html');
  ...
  class ListValueStrong extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-value-strong', ListValueStrong);
