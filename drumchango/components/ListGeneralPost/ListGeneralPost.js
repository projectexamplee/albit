(async () => {
  const res = await fetch('components/ListGeneralPost/ListGeneralPost.html');
  ...
  class ListGeneralPost extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-general-post', ListGeneralPost);
