(async () => {
  const res = await fetch('components/ListTextAreaBig/ListTextAreaBig.html');
  ...
  class ListTextAreaBig extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-text-area-big', ListTextAreaBig);
