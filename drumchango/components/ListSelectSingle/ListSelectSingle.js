(async () => {
  const res = await fetch('components/ListSelectSingle/ListSelectSingle.html');
  ...
  class ListSelectSingle extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-select-single', ListSelectSingle);
