(async () => {
  const res = await fetch('components/ListHorizonArtist/ListHorizonArtist.html');
  ...
  class ListHorizonArtist extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-horizon-artist', ListHorizonArtist);
