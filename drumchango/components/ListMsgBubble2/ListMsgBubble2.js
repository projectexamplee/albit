(async () => {
  const res = await fetch('components/ListMsgBubble2/ListMsgBubble2.html');
  ...
  class ListMsgBubble2 extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-msg-bubble2', ListMsgBubble2);
