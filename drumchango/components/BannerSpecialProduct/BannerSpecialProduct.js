(async () => {
  const res = await fetch('components/BannerSpecialProduct/BannerSpecialProduct.html');
  ...
  class BannerSpecialProduct extends HTMLElement {
    constructor() {
  ...
  customElements.define('banner-special-product', BannerSpecialProduct);
