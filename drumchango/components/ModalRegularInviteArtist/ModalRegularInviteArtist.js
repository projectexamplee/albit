(async () => {
  const res = await fetch('components/ModalRegularInviteArtist/ModalRegularInviteArtist.html');
  ...
  class ModalRegularInviteArtist extends HTMLElement {
    constructor() {
  ...
  customElements.define('modal-regular-invite-artist', ModalRegularInviteArtist);
})();
