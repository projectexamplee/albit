(async () => {
  const res = await fetch('components/CardHuge/CardHuge.html');
  ...
  class CardHuge extends HTMLElement {
    constructor() {
    ...
    connectedCallback() {
      ...
      this.querySelector('.card_huge_img_top').style.backgroundImage =  "url(" + imgSrc + ")";
  ...
  customElements.define('card-huge', CardHuge);
