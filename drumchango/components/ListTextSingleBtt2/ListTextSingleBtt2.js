(async () => {
  const res = await fetch('components/ListTextSingleBtt2/ListTextSingleBtt2.html');
  ...
  class ListTextSingleBtt2 extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-text-single-btt2', ListTextSingleBtt2);
