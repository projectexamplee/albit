(async () => {
  const res = await fetch('components/ListOrderItem/ListOrderItem.html');
  ...
  class ListOrderItem extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-order-item', ListOrderItem);
