(async () => {
  const res = await fetch('components/ListCartItem/ListCartItem.html');
  ...
  class ListCartItem extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-cart-item', ListCartItem);
