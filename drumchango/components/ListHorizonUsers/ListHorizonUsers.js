(async () => {
  const res = await fetch('components/ListHorizonUsers/ListHorizonUsers.html');
  ...
  class ListHorizonUsers extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-horizon-users', ListHorizonUsers);
