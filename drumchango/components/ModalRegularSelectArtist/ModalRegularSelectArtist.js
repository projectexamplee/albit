(async () => {
  const res = await fetch('components/ModalRegularSelectArtist/ModalRegularSelectArtist.html');
  ...
  class ModalRegularSelectArtist extends HTMLElement {
    constructor() {
  ...
  customElements.define('modal-regular-select-artist', ModalRegularSelectArtist);
})();
