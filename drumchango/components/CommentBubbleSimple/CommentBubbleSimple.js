(async () => {
  const res = await fetch('components/CommentBubbleSimple/CommentBubbleSimple.html');
  ...
  class CommentBubbleSimple extends HTMLElement {
    constructor() {
  ...
  customElements.define('comment-bubble-simple', CommentBubbleSimple);
