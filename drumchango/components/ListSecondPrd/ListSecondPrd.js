(async () => {
  const res = await fetch('components/ListSecondPrd/ListSecondPrd.html');
  ...
  class ListSecondPrd extends HTMLElement {
    constructor() {
  ...
  customElements.define('list-second-prd', ListSecondPrd);
