...
function setGeneralFlowChart(flowData){
	...
	generalNodeArray = [
		...
		{node_title_eng:"departure_node",node_title_kor:"출발지노드",index:2,value:flowData.source,block:flowData.source_block},
		{node_title_eng:"service_node",node_title_kor:"서비스",index:5,value:flowData.service,block:0},
		{node_title_eng:"arrival_node",node_title_kor:"도착지노드",index:6,value:flowData.destination,block:0}
	];
